...
namespace CampDios.Controllers
{
    ...
    public class GrupoController : Controller
    {
        ...
        // GET: Grupo
        [AuthorizeUserAccesLevel(UserRole = true, Vista = "Grupos", Permiso = "Lectura")]
        ...
        // GET: Grupo/Create
        [AuthorizeUserAccesLevel(UserRole = true, Vista = "Grupos", Permiso = "Escritura")]
        ...
        // GET: Grupo/Edit/5
        [AuthorizeUserAccesLevel(UserRole = true, Vista = "Grupos", Permiso = "Edicion")]
